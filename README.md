...
A composite repository: cross-sphere capabilities, each classified by the spheres its evidence spans.
...
here relies on: Each composite names the sphere maintainers of every sphere it touches, and a composite change needs review from each of them. None engaged yet.
